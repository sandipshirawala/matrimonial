...
<div class="container">
	...
	<div class="check">	 
		 ...
		 <div class="col-md-12 cart-items">
			<h1>Invoice # <?php echo $ord_id; ?></h1>
			<table class="table table-bordered">
			    <thead>
			    <?php 
			    $this->db->join("tbl_agent","tbl_order.order_agent=tbl_agent.agent_id","left outer");
       	 	    $od_res=$this->db->get_where('tbl_order',array("order_id"=>$ord_id));
			    foreach($od_res->result() as $od_row)
			    {
			    ?>
				    <tr>
				    	<td width="15%"><strong>Party Name </strong></td><td width="35%"><?php echo $od_row->order_name; ?></td><td width="15%"><strong>GST Number</strong></td><td width="35%"><?php echo $od_row->order_gst_number; ?></td>
				  	</tr>
				  	<tr>
				    	<td><strong>Agent </strong></td><td><?php echo $od_row->agent_name; ?></td><td><strong>Transport</strong></td><td><?php echo $od_row->order_transport; ?></td>
				  	</tr>
				  	<tr>
				    	<td><strong>Packaging </strong></td><td><?php echo $od_row->order_packaging; ?></td><td><strong>Email</strong></td><td><?php echo $od_row->order_email; ?></td>
				  	</tr>
				  	
				  	<tr>
				    	<td><strong>Mobile </strong></td><td><?php echo $od_row->order_mobile; ?></td><td><strong>GST Number</strong></td><td><?php echo $od_row->order_gst_number; ?></td>
				  	</tr>
				  	<tr>
				  		<td><strong>Amount </strong></td><td><?php echo $od_row->order_amount; ?><td><strong>Status</strong></td><td><?php echo $od_row->order_status; ?></td>
				  	</tr>
				  	<tr>
				    	<td><strong>Remarks </strong></td><td colspan="3"><?php echo $od_row->order_remarks; ?></td>
				  	</tr>
				<?php
				} 
				?>
			 ...
			 foreach($cart_res->result() as $cart_row)
			 {
				 ...
				 <div class="cart-header">
					 ...
					 <div class="cart-sec simpleCart_shelfItem">
						   ...
						   <div class="cart-item-info">
							<h3><a href="#"><?php echo "(".$i.") "; ?><?php echo $cart_row->volume_name; ?> (Full Catalogue)</a> - <?php echo $vol_pro_count." Designs"; ?>
							<!--<span>Model No: 3578</span>--></h3>
							<ul class="qty">
								<!--<li><p>Size : 5</p></li>-->
								<li><p>Qty of Catalogue : <?php echo $cart_row->order_qty; ?>
								<!-- <input type='text' value="<?php echo $cart_row->order_qty; ?>" size="5" onblur="changeqty('volume','<?php echo $cart_row->volume_id; ?>',this.value)" >--></p></li>
								<div class="delivery" style="float:right">
									 <p>Total Quantity : <?php echo ($vol_pro_count*$cart_row->order_qty); ?></p>
			 	...
			 	<div class="cart-header">
					 ...
					 <div class="cart-sec simpleCart_shelfItem">
						   ...
						   <div class="cart-item-info">
							<h3><a href="#"><?php echo "(".$i.") "; ?><?php echo $cart_row->volume_product_name; ?></a>
							<!--<span>Model No: 3578</span>--></h3>
							<ul class="qty">
								...
								<li style="padding-top:7px"><p>Qty of Single Unit : <?php echo $cart_row->order_qty; ?>
								<!--<input type='text' value="<?php echo $cart_row->order_qty; ?>" size="5"  onblur="changeqty('product','<?php echo $cart_row->volume_product_id; ?>',this.value)" >--></p></li>
								<div class="delivery" style="float:right">
									 <p>Total Quantity : <?php echo $cart_row->order_qty; ?></p>
									 <!--<span>Delivered in 2-3 bussiness days</span>
									 <div class="clearfix"></div>-->
						        </div>	
							</ul>
