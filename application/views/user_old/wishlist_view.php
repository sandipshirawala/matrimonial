...
<div class="container">
	...
	<div class="check">	 
		 ...
		 <div class="col-md-9 cart-items">
			 ...
			 */
			 $cart_query ="SELECT `tbl_wishlist`.`volume_product_id`,`tbl_wishlist`.`volume_id`,
			 ...
			 FROM (`tbl_wishlist`)
LEFT OUTER JOIN `tbl_volume` ON `tbl_wishlist`.`volume_id` = `tbl_volume`.`volume_id`
LEFT OUTER JOIN `tbl_volume_product` ON `tbl_wishlist`.`volume_product_id` = `tbl_volume_product`.`volume_product_id`
WHERE `tbl_wishlist`.`user_id` = '".$_SESSION["user_id"]."'";
			...
			$cart_res=$this->db->query($cart_query);
			 foreach($cart_res->result() as $cart_row)
			 {
			 	...
			 	?>
				 <div class="cart-header" style="margin-top:10px">
					 <a href="<?php echo base_url(); ?>user/remove_wishlist/volume/<?php echo $cart_row->volume_id; ?>"><div class="close1"></div></a>
					 <div class="cart-sec simpleCart_shelfItem">
							<div class="cart-item cyc item">
								 <img style="max-height:120px;max-width:110px" src="<?php echo base_url(); ?>files/admin/volume/thumb/<?php echo $cart_row->volume_image; ?>" class="img-responsive" alt=""/>
								 	 <a class="add-to-cart home_cart_btn" style="margin-top:3px" type="button"  onclick="add_to_cart('volume',<?php echo $cart_row->volume_id; ?>);" >Add to carts</a>
			 	...
			 	?>
			 	<div class="cart-header"  style="margin-top:10px">
					 <a href="<?php echo base_url(); ?>user/remove_wishlist/product/<?php echo $cart_row->volume_product_id; ?>"><div class="close1"></div></a>
					 <div class="cart-sec simpleCart_shelfItem">
							<div class="cart-item cyc item">
								 ...
								 <a class="add-to-cart home_cart_btn" type="button"  onclick="add_to_cart('product',<?php echo $cart_row->volume_product_id; ?>);" >Add to cart</a>
							</div>
						   <div class="cart-item-info">
