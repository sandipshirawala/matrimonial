				  ...
				  <div class="contact-form col-md-9">
			 	 	    ...
			 	 	    <form method="post" action="<?php echo base_url(); ?>user/edit_profile/do_update">
					    	<div>
						    	...
						    	<span><input name="txt_full_name" id="txt_full_name" type="text" class="textbox" value="<?php echo $edit_row->user_full_name; ?>"></span>
						    </div>
						    <div>
						    	<span><label>Mobile</label></span>
						    	<span><input name="txt_mobile" id="txt_mobile" type="text" class="textbox" value="<?php echo $edit_row->user_mobile; ?>"></span>
						    </div>
						    <div>
						    	<span><label>Address</label></span>
						    	<span><textarea name="txt_address" id="txt_address"><?php echo $edit_row->user_address; ?></textarea></span>
						    </div>
						   <div>
						   		<span><input type="submit" class="" value="Update Profile"></span>
						  </div>
					    </form>
					    <?php 
						}
