    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <!-- Add Modal Form -->
                <div class="row">
                    <div class="col-lg-12">
<form role="form" method="post" action="<?php echo base_url(); ?>admin/manage_caste/create" enctype="multipart/form-data">
    <div class="form-group">
                <label>Caste Name</label>
                <input class="form-control" id="txt_caste_name" name="txt_caste_name">
    </div>
    <div class="form-group">
                <label>Sort Order</label>
                <input class="form-control" id="txt_caste_sort_order" name="txt_caste_sort_order">
    </div>
    <div class="form-group">
                <label>Status</label>
                <?php 
...
<div id="page-wrapper">
    ...
    <!-- Page Heading -->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Caste List
                    <label style="float:right">
                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Add New Caste</button>
                    </label>
                </h1>
                <!--<ol class="breadcrumb">
                <li>
        ...
        <tr>
            <td><?php echo $i; ?></td>
            <td><?php echo $result_row->caste_name; ?></td>
            <td><?php echo $result_row->caste_sort_order; ?></td>
            <td><?php echo $result_row->caste_status; ?></td>
                <td><?php echo $result_row->religion_name; ?></td>
            <td>
                <a class="btn btn-success" class="btn btn-info" data-toggle="modal" data-target="#editModal" onclick="get_edit_data(<?php echo $result_row->caste_id; ?>);"><em class="fa fa-pencil"></em></a>
                <a class="btn btn-danger confirm-delete" data-id="<?php echo $result_row->caste_id; ?>"><em class="fa fa-trash-o"></em></a>
            </td>
        </tr>
        <?php
            $i++;
...
$('#btnYes').click(function() {
    ...
    //$('[data-id='+id+']').remove();
    window.location=base_url+'admin/manage_caste/delete/'+id;
