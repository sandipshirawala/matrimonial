  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Add Subscribe Email</h4>
        </div>
        <div class="modal-body">
            <!-- Add Modal Form -->
                <div class="row">
                    <div class="col-lg-12">
<form role="form" method="post" action="<?php echo base_url(); ?>admin/manage_subscribe_email/create" enctype="multipart/form-data">
...
<div id="page-wrapper">
    ...
    <!-- Page Heading -->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Subscribe Email List
                    <label style="float:right">
                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Add New Subscribe Email</button>
                    </label>
                </h1>
                <!--<ol class="breadcrumb">
                <li>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-success" class="btn btn-info" data-toggle="modal" data-target="#editModal" onclick="get_edit_data(<?php echo $result_row->subscribe_email_id; ?>);"><em class="fa fa-pencil"></em></a>
                <a class="btn btn-danger confirm-delete" data-id="<?php echo $result_row->subscribe_email_id; ?>"><em class="fa fa-trash-o"></em></a>
            </td>
        </tr>
        <?php
            $i++;
...
<div id="editModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Edit Subscribe Email</h4>
        </div>
        <div class="modal-body">
            <!-- Edit Modal Form -->
                <div class="row">
...
<script type="text/javascript">
            var controller = "ajax/get_subscribe_email";
...
$('#btnYes').click(function() {
    ...
    //$('[data-id='+id+']').remove();
    window.location=base_url+'admin/manage_subscribe_email/delete/'+id;
