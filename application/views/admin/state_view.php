    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <!-- Add Modal Form -->
                <div class="row">
                    <div class="col-lg-12">
<form role="form" method="post" action="<?php echo base_url(); ?>admin/manage_state/create" enctype="multipart/form-data">
    <div class="form-group">
                <label>State Name</label>
                <input class="form-control" id="txt_state_name" name="txt_state_name">
    </div>
    <div class="form-group">
                <label>Country</label>
...
<div id="page-wrapper">
    ...
    <!-- Page Heading -->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">State List
                    <label style="float:right">
                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Add New State</button>
                    </label>
                </h1>
                <!--<ol class="breadcrumb">
                <li>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-success" class="btn btn-info" data-toggle="modal" data-target="#editModal" onclick="get_edit_data(<?php echo $result_row->state_id; ?>);"><em class="fa fa-pencil"></em></a>
                <a class="btn btn-danger confirm-delete" data-id="<?php echo $result_row->state_id; ?>"><em class="fa fa-trash-o"></em></a>
            </td>
        </tr>
        <?php
            $i++;
...
$('#btnYes').click(function() {
    ...
    //$('[data-id='+id+']').remove();
    window.location=base_url+'admin/manage_state/delete/'+id;
