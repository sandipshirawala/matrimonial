    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <!-- Add Modal Form -->
                <div class="row">
                    <div class="col-lg-12">
<form role="form" method="post" action="<?php echo base_url(); ?>admin/manage_city/create" enctype="multipart/form-data">
    <div class="form-group">
                <label>City Name</label>
                <input class="form-control" id="txt_city_name" name="txt_city_name">
    </div>
    <div class="form-group">
                <label>State</label>
...
<div id="page-wrapper">
    ...
    <!-- Page Heading -->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">City List
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-success" class="btn btn-info" data-toggle="modal" data-target="#editModal" onclick="get_edit_data(<?php echo $result_row->city_id; ?>);"><em class="fa fa-pencil"></em></a>
                <a class="btn btn-danger confirm-delete" data-id="<?php echo $result_row->city_id; ?>"><em class="fa fa-trash-o"></em></a>
            </td>
        </tr>
        <?php
            $i++;
...
$('#btnYes').click(function() {
    ...
    //$('[data-id='+id+']').remove();
    window.location=base_url+'admin/manage_city/delete/'+id;
